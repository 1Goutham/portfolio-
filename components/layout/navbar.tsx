...
import brainwave from "../../public/assets/headerlogo.png";
    ...
    >
      <div className={cn(`flex items-center px-5 max-lg:py-4 lg:px-7.5 xl:px-10`)}>
        <Link href="#hero" className={cn(`block w-48 xl:mr-8`)}>
          <Image src={brainwave} className="m-5" alt="brainwave" width={50} height={50} />
        </Link>
        ...
        <a href="https://www.linkedin.com/in/hariharan-s-699b58220/" target="_blank">
